...
/**
 *
 * Estructura de cada registro (longitudes fijas): Clave: entero (4 bytes)
 * Nombre del equipo: 30 caracteres (60 bytes, cada char = 2 bytes) Nombre de 4
 * jugadores: 20 caracteres cada uno (4 * 40 = 160 bytes) Resultado: 10
 * caracteres (20 bytes)
 *
 * @author sebas
 * @since 03/10/2025
...
public class ConexionAleatoria {
     ...
     * @param jugadores Arreglo con los 4 nombres de jugadores (máx. 20
     * caracteres cada uno)
    ...
    /**
     * Escribe una cadena en un campo de tamaño fijo. Si es más corta, se
     * rellena con caracteres nulos. Si es más larga, se recorta.
     *
